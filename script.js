...
const micNode = new MediaStreamAudioSourceNode(liveRingModCtx, {
...
//connect constant source to osc
modFreq.connect(modOsc.frequency);

//connect osc to mod gain
modOsc.connect(modulationGainNode.gain);

//connect mic to mod gain
micNode.connect(modulationGainNode);

//send mod to master gain
modulationGainNode.connect(masterGainNode);

//send to speakers
masterGainNode.connect(liveRingModCtx.destination);
